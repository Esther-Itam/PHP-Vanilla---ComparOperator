...
if (isset($valider)) {
   ...
   $sel = $pdo->prepare("select * from administrator where username=? and password=? limit 1");
...
<body onLoad="document.fo.login.focus()">
   ...
   <nav class="white" role="navigation">
    <div class="nav-wrapper container">
      ...
      <ul class="right hide-on-med-and-down">
        ...
        <li><a href="../../tourOperatorPage/authentification/login.php">Tour Opérateur</a></li>
      </ul>
            ...
            <div class="col s6 center">
               ...
               <form name="fo" method="post" action="">
                  <div class="input-field col s6">
                     ...
                     <input id="icon_prefix" type="text" class="validate" name="username" value="administrateur">
                  ...
                  <div class="input-field col s6">
                     ...
                     <input id="password" type="password" class="validate" name="password" placeholder="Mot de passe" value="administrator">
                     <label for="password">Mot de passe</label>
                  </div>

                  <button class="button waves-effect waves-light btn-info center" class="favorite styled" name="valider" type="submit">S'authentifier</button>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col l3 s12">
        ...
        <ul>
          <li><a class="white-text" href=""><font color="#114944"><i>Administrateur</i></font></a></li>
          <li><a class="white-text" href="../../../partials/tourOperatorPage/authentification/login.php"><font color="#114944"><i>Tour Opérateur</i></font></a></li>
        </ul>
      </div>

      <div class="col l3 s12">
        <h5 class="white-text">Lien GitHub du site</h5>
          <a href="https://github.com/Esther-Itam?tab=repositories" target="_blank" width="50px" >
  ...
  <div class="footer-copyright">
    <div class="container">
    © 2021 Copyright - Made by <a class="brown-text text-lighten-3" href="http://esther-itam.fr/">Esther Itam</a>
    </div>
  </div>
</footer>
